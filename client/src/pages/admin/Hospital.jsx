...
const Hospital = () => {
  ...
  return (
    <section className="hospital h-100 w-100" style={{ boxSizing: 'border-box', backgroundColor: '#FFFFFF' }}>
          ...
          <div className="recently d-flex flex-column">
            ...
            <Link to="/hospital/create">
              <button className="btn btn-primary">
                <AiOutlinePlus className="mb-1" /> Tambah Data
              </button>
            </Link>
            {/* Table Start */}
                  ...
                  ? hospitals.length != 0
                    ? hospitals.map((hospital, i) => (
                        <tr key={i}>
                          ...
                          <td className="text-center">{hospital.title}</td>
                          <td className="text-center">{hospital.alamat}</td>
